		...
		private void Install65sc02Instructions()
		{
			if (this.level >= ProcessorType.cpu65sc02)
			{
				this.overlay65sc02 = new Instruction[]
				{
					...
					/* 1 */	INS(this.___, 0, AddressingMode.Illegal, "___"),        INS(this.___, 0, AddressingMode.Illegal, "___"),        INS(this.ORA_zpind, 5, AddressingMode.ZeroPageIndirect, "ORA"), INS(this.___, 0, AddressingMode.Illegal, "___"),    INS(this.TRB_zp, 5, AddressingMode.ZeroPage, "TRB"),    INS(this.___, 0, AddressingMode.Illegal, "___"),        INS(this.___, 0, AddressingMode.Illegal, "___"),        INS(this.___, 0, AddressingMode.Illegal, "___"),    INS(this.___, 0, AddressingMode.Illegal, "___"),        INS(this.___, 2, AddressingMode.Illegal, "___"),            INS(this.INC_imp, 2, AddressingMode.Implied, "INC"),    INS(this.___, 0, AddressingMode.Illegal, "___"),    INS(this.TRB_abs, 6, AddressingMode.Absolute, "TRB"),               INS(this.___, 2, AddressingMode.Illegal, "___"),            INS(this.___, 2, AddressingMode.Illegal, "___"),            INS(this.___, 2, AddressingMode.Illegal, "___"),
					...
					/* 3 */	INS(this.___, 0, AddressingMode.Illegal, "___"),        INS(this.___, 0, AddressingMode.Illegal, "___"),        INS(this.AND_zpind, 5, AddressingMode.ZeroPageIndirect, "AND"), INS(this.___, 0, AddressingMode.Illegal, "___"),    INS(this.BIT_zpx, 4, AddressingMode.ZeroPageX, "BIT"),  INS(this.___, 0, AddressingMode.Illegal, "___"),        INS(this.___, 0, AddressingMode.Illegal, "___"),        INS(this.___, 0, AddressingMode.Illegal, "___"),    INS(this.___, 0, AddressingMode.Illegal, "___"),        INS(this.___, 2, AddressingMode.Illegal, "___"),            INS(this.DEC_imp, 2, AddressingMode.Implied, "DEC"),    INS(this.___, 0, AddressingMode.Illegal, "___"),    INS(this.BIT_absx, 4, AddressingMode.AbsoluteX, "BIT"),             INS(this.___, 2, AddressingMode.Illegal, "___"),            INS(this.___, 2, AddressingMode.Illegal, "___"),            INS(this.___, 2, AddressingMode.Illegal, "___"),
